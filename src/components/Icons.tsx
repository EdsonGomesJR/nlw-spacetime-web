...
export const PhoneIcon = (
  ...
  >
    <path
      fill="currentColor"
      d="M48.888 36.55a13.503 13.503 0 0 1-13.411 11.741c-19.057 0-34.56-15.504-34.56-34.56A13.503 13.503 0 0 1 12.656.32a3.84 3.84 0 0 1 3.989 2.284l5.069 11.317v.028a3.84 3.84 0 0 1-.305 3.622 2.626 2.626 0 0 1-.137.185l-4.997 5.923c1.798 3.653 5.619 7.44 9.32 9.243l5.841-4.971c.058-.048.118-.093.18-.134a3.84 3.84 0 0 1 3.641-.336l.031.014 11.307 5.067a3.84 3.84 0 0 1 2.292 3.988Z"
    />
  </svg>
)
...
export const ShieldIcon = (
  ...
  >
    <path
      fill="currentColor"
      d="M43.16.291H4.756a3.84 3.84 0 0 0-3.84 3.84v14.107c0 21.51 18.198 28.644 21.842 29.854a3.707 3.707 0 0 0 2.4 0C28.806 46.88 47 39.746 47 18.235V4.132a3.84 3.84 0 0 0-3.84-3.84ZM31.639 23.333h-5.76v5.76a1.92 1.92 0 0 1-3.841 0v-5.76h-5.76a1.92 1.92 0 0 1 0-3.84h5.76v-5.76a1.92 1.92 0 0 1 3.84 0v5.76h5.76a1.92 1.92 0 1 1 0 3.84Z"
    />
  </svg>
)
export const StarIcon = (
  ...
  >
    <path
      fill="currentColor"
      d="m16.049 7.988-3.156 2.859.945 4.256c.05.223.036.456-.04.67-.078.214-.213.4-.392.534a1.088 1.088 0 0 1-1.237.056L8.594 14.11l-3.569 2.252a1.088 1.088 0 0 1-1.236-.056 1.159 1.159 0 0 1-.391-.534 1.204 1.204 0 0 1-.041-.67l.944-4.252-3.157-2.863a1.168 1.168 0 0 1-.347-.567c-.06-.22-.055-.454.013-.672.069-.217.197-.41.37-.551.173-.142.382-.229.602-.248l4.16-.374 1.625-4.02a1.15 1.15 0 0 1 .411-.519 1.087 1.087 0 0 1 1.238 0c.183.127.326.307.411.518l1.63 4.021 4.159.374c.22.02.429.106.602.248.173.142.301.334.37.551.067.218.072.452.012.672-.059.22-.18.418-.347.567h-.003Z"
    />
  </svg>
)
